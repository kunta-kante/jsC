  ...
  //   let team = 'aveNgers';
  //   //=> Avengers
  // //   const firstLetter = team[0].toUpperCase();
  // //   const restLetter = (team.substring(1)).toLowerCase();
  ...
  let villes = ["freetown", "makeni", "kono", "kenema", "BO"];
  console.log(villes[3]);
  villes.splice(villes.length, 0, "kabala");
  console.log(villes);
  villes.splice(2, 1);
  console.log(villes);
  ...
  //   console.log(promo.reduce(reducer));
  ...
  //   const names = ["paul", "john", "ringo", "george"];
  //   const namesMaj = names.map((Element) => Element.toUpperCase())
  //   console.log(namesMaj);
  ...
  const capitalize = (word) => {
      console.log(word[0].toUpperCase() + word.slice().toLowerCase());
  };
  capitalize(mot);
